...
2. Data loading branches by runtime mode: SQLite in normal execution and JSON resources during Surefire tests.
...
5. Save path reflects `savePrescription()` replacement-by-patient behavior and full SQLite transaction rewrite.
