...
## Behavioral Notes:
1. Data load now explicitly includes runtime branch logic (`useExternalDataFallback`) for PostgreSQL vs JSON sources.
...
5. Save path reflects `APPROVED` transition and full-table PostgreSQL rewrite transaction.
